function point2pixel(point_val){
	return parseFloat(point_val) * 1.333333333;
}
...
•	 Translations are specified as [1 0 0 1 t x t y ] , where t x and t y are the horizontal and vertical
distances to move the object, relative to the center of the pasteboard.

•	 Scaling is obtained using the matrix [s x 0 0 s y 0 0] . This scales the object in a given element
by s x (horizontal scaling factor) and s y (vertical scaling factor), relative to the pasteboard.

•	 Rotations are produced by the matrix [cos(0) sin(0) -sin(0) cos(0) 0 0] , which has the
effect of rotating the object counterclockwise by the angle 0 , relative to the pasteboard.

•	 Skewing is specified by the matrix [1 tan(a) tan(b) 1 0 0] , which skews the x (horizontal)
axis of the object by the angle a and t
/*********************************/
