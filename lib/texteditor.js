...
(function (Textor) {
    var TextEditor = (function () {
        function TextEditor(canvas, tub, bounding_x, bounding_y, bounding_w, bounding_h) {
            var _this = this;
            
            this.bounding_x = bounding_x;
            this.bounding_y = bounding_y;
            this.bounding_w = bounding_w;
            this.bounding_h = bounding_h;
            ...
            // console.log((this._canvas.clientWidth * this.devicePixelRatio));
            ...
            this._context.translate(tub['page_info']['center_offset'], 50);
            ...
            this._theme = {
                ...
                "paddingLeft": "4",
                "paddingTop": "4",
                //"backgroundColor": "#ffffff", // this...
                "backgroundColor": "#CCC", // this...
                "backgroundBlurColor": "#ffffff",
                "selectionColor": "#c0ddf6",
                "selectionBlurColor": "#e3f1fe",
                "cursorColor": "#000000",
                "cursorBackgroundColor": "#ededed", // this...
                "textStyle": "#000000",
        ...
        TextEditor.prototype.update = function () {
            ...
            if (this._invalidRectangles.length !== 0) {
                ...
                if ((clipRectangle.width !== 0) && (clipRectangle.height !== 0)) {
                    ...
                    //this._context.rect(clipRectangle.x+5, clipRectangle.y+5, clipRectangle.width-10, clipRectangle.height-10);
                    
                    
                    this._context.rect(this.bounding_x, this.bounding_y, this.bounding_w, this.bounding_h);
                    ...
                    // JON redraw
                    //
                    this._context.fillRect(this.bounding_x, this.bounding_y, this.bounding_w , this.bounding_h);
                    ...
                    // console.log(selection.start.column);
                    
                    
                    if (this._textModel.isCursor()) {
                    	
                    	// JON - current line selected
                    	
                        // draw selected line
                        this._context.fillStyle = this._theme.cursorBackgroundColor;
                        var y = (selection.start.line * fontSize.height) + paddingTop;
                        y = y + parseFloat(this.bounding_y);
                        this._context.fillRect(this.bounding_x, y, this.bounding_w, fontSize.height);
                        ...
                        if (this._blinkState && this._textController.isFocused()) {
                            ...
                            var tx = paddingLeft + (selection.start.column * fontSize.width) + parseFloat(this.bounding_x);
                            	
                        	this._context.fillRect(tx, y, 1, fontSize.height);
                            //this._context.fillRect(tx, y, 1, fontSize.height);
                        }
                        
                    }else{
                    	
                    	// JON - text highlight by drag selection
                        ...
                        for (var line = 0; line < size.line; line++) {
                            var x = 0;
                            //x = x + parseFloat(this.bounding_x);
                            ...
                            if (line < this._textBuffer.getLines()) {
                                ...
                                while (position < text.length) {
                                    ...
                                    if ((currentStyle === style) && ((column - this._scrollPosition.column + part.length) > 0) && ((column - this._scrollPosition.column) < size.column)) {
                                    	...
                                    	var tx = (column - this._scrollPosition.column) * fontSize.width + paddingLeft + parseFloat(this.bounding_x);
                                    	//y = y + parseFloat(this.bounding_y);
                                    	
                                    	
                                    	// ctx.fillText(text, x, y [, maxWidth]);
                                    	this._context.fillText(part, tx, y);
                                        //this._context.fillText(part, (column - this._scrollPosition.column) * fontSize.width + paddingLeft +10, y+10);
